                ...
                <form id="pendaftaranForm" action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    @if (Auth::user()->roles == 'admin' || Auth::user()->roles == 'petugas')
                        <div class="form-group">
                            <label>Kirim ke WhatsApp?</label><br>
                            <input type="radio" name="kirim_whatsapp" value="yes" onclick="toggleNoTelp(true)"> Ya<br>
                            <input type="radio" name="kirim_whatsapp" value="no" onclick="toggleNoTelp(false)"> Tidak
                        </div>
